    ...
    public void costClick(View view) {
        ...
        switch (id) {
            case R.id.bt_costAll:
                ...
                ft.replace(R.id.fl_fragment, cardsFragment.newInstance("mage", -1));
            ...
            case R.id.bt_cost0:
                ...
                ft.replace(R.id.fl_fragment, cardsFragment.newInstance("mage", 0));
                break;
            case R.id.bt_cost1:
                ft.replace(R.id.fl_fragment, cardsFragment.newInstance("mage", 1));
                break;
            case R.id.bt_cost2:
                ft.replace(R.id.fl_fragment, cardsFragment.newInstance("mage", 2));
                break;
            case R.id.bt_cost3:
                ft.replace(R.id.fl_fragment, cardsFragment.newInstance("mage", 3));
                break;
            case R.id.bt_cost4:
                ft.replace(R.id.fl_fragment, cardsFragment.newInstance("mage", 4));
                break;
            case R.id.bt_cost5:
                ft.replace(R.id.fl_fragment, cardsFragment.newInstance("mage", 5));
                break;
            case R.id.bt_cost6:
                ft.replace(R.id.fl_fragment, cardsFragment.newInstance("mage", 6));
                break;
            case R.id.bt_cost7plus:
                ft.replace(R.id.fl_fragment, cardsFragment.newInstance("mage", 7));
                break;
